              ...
              <tr>
                <td align="center">
                  ...
                  >
                              ...
                              >
                                <tr>
                                  <td align="left" style="font-size: 0px">
                                    <a
                                      target="_blank"
                                      href="https://www.theeventjet.com"
                                      ><img
                                        class="adapt-img"
                    ...
                    <tr>
                      <td class="es-p20t es-m-p0b" align="left">
                              ...
                              >
                                <tr>
                                  <td align="left">
                                    ...
                                    <p style="font-size: 14px">
                                      ${formHour(data?.door_time)} -
                                      ${formHour(data?.end_time)}
                                    </p>
                                    <p style="font-size: 14px">
                                      ${data?.location_comp}
                                    </p>
...
module.exports = teamAccessEmail;
